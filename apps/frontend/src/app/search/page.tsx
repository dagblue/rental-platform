    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="all">All regions</SelectItem> {/* Changed from "" to "all" */}
      ...
      <div>
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="all">Any condition</SelectItem> {/* Changed from "" to "all" */}
      ...
      {/* Trust Level */}
      <div>
        <h3 className="font-semibold mb-3">Minimum Trust Level</h3>
        <Select 
          value={filters.minTrustLevel} 
          onValueChange={(value: string) => {
            setFilters({ ...filters, minTrustLevel: value === 'all' ? '' : value });
            setCurrentPage(1);
          }}
        >
          <SelectTrigger>
          ...
          <SelectContent>
            <SelectItem value="all">Any level</SelectItem> {/* Changed from "" to "all" */}
          ...
          <div className="flex-1">
            ...
            {hasActiveFilters() && (
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                {filters.minTrustLevel && (
                  <Badge variant="secondary" className="flex items-center gap-1">
                    Trust: {filters.minTrustLevel}
                    <X className="h-3 w-3 cursor-pointer" onClick={() => {
                      setFilters({ ...filters, minTrustLevel: '' });
                      setCurrentPage(1);
                    }} />
                  </Badge>
                )}
